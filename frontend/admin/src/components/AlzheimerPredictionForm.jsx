                ...
                {prediction && (
                    <Box mt={6}>
                        ...
                        <VStack align="stretch">
                            ...
                            <PredictionItem label="Mildly Demented" value={(prediction.mildly_demented * 100).toFixed(2) + '%'} />
                            <PredictionItem label="Moderately Demented" value={(prediction.moderately_demented * 100).toFixed(2) + '%'} />
                            <PredictionItem label="Non Demented" value={(prediction.non_demented * 100).toFixed(2) + '%'} />
                            <PredictionItem label="Very Mildly Demented" value={(prediction.very_mildly_demented * 100).toFixed(2) + '%'} />
                        </VStack>
                    </Box>
                )}
                <Input
