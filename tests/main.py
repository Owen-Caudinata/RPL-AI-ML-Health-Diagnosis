...
from test_ehr import UserVisitEHR
from test_ehr import AdminVisitEHR
...
if __name__ == "__main__":
    ...
    test_suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(UserVisitEHR))
    test_suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(AdminVisitEHR))
